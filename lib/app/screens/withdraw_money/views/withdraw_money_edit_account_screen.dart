...
class WithdrawMoneyEditAccountScreen extends StatefulWidget {
  const WithdrawMoneyEditAccountScreen({super.key, this.accountId});
  final String? accountId;

  @override
  State<WithdrawMoneyEditAccountScreen> createState() => _WithdrawMoneyEditAccountScreenState();
}

class _WithdrawMoneyEditAccountScreenState extends State<WithdrawMoneyEditAccountScreen> {
  final formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    return MyCustomScaffold(
      pageTitle: MyStrings.editAccount,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DynamicFormWidgetView(
                            ...
                            autoFillDataList: controller.selectedAccountDynamicFormAutofillData ?? [],
                          ),
                        ],
                      ),
                    ),

...
import 'package:ovopayagent/app/screens/auth/biometric/controller/biometric_controller.dart';
import 'package:ovopayagent/app/screens/global/controller/country_controller.dart';
import 'package:ovopayagent/core/data/models/auth/login/login_response_model.dart';
import 'package:ovopayagent/core/data/models/auth/sign_up_model/registration_response_model.dart';
...
import 'package:ovopayagent/core/data/repositories/auth/login_repo.dart';
  ...
  void loginUser() async {
    try {
      ...
      if (model.statusCode == 200) {
        ...
        if (loginModel.remark == "agent_not_found") {

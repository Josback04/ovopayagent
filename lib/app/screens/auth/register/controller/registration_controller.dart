...
import 'package:ovopayagent/core/data/models/profile_complete/profile_complete_post_model.dart';
import 'package:ovopayagent/core/data/models/user/user_model.dart';

import 'package:ovopayagent/core/data/repositories/auth/signup_repo.dart';
...
class RegistrationController extends GetxController {
  ...
  //VERIFY SMS START
  void onChangeOtpWidgetText({String value = ""}) {
  ...
  Future<void> verifyYourSms({required void Function() onSuccess}) async {
    ...
    try {
      ...
      if (responseModel.statusCode == 200) {
        ...
        if (model.status == AppStatus.SUCCESS) {
          ...
          UserModel? userModel = model.data?.agent;
          if (userModel != null) {

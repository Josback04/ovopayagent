...
import 'package:ovopayagent/app/screens/transaction_history/views/widgets/transaction_history_bottom_sheet_details_card.dart';
...
final List<TransActionIconItem> transactionIconsList = [
  TransActionIconItem(
    ...
    label: ["cash_out_commission", "cash_out"],
    isActive: true,
    activeColor: MyColor.violateColor,
  ),
  TransActionIconItem(
    icon: MyIcons.sendIcon,
    label: ["cash_in", "cash_in_commission"],
    isActive: true,
  ...
  TransActionIconItem(
    ...
    label: ["withdraw", "withdraw_reject"],
    isActive: true,

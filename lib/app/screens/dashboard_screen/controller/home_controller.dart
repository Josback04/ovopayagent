...
import 'package:ovopayagent/core/data/models/country_model/country_model.dart';
import 'package:ovopayagent/core/data/models/global/module/app_module_response_model.dart';
import 'package:ovopayagent/core/data/models/global/response_model/response_model.dart';
import 'package:ovopayagent/core/data/models/home/dashbaord_response_model.dart';
import 'package:ovopayagent/core/data/models/transaction_history/transaction_history_model.dart';
import 'package:ovopayagent/core/data/repositories/auth/general_setting_repo.dart';
import 'package:ovopayagent/core/data/repositories/home/home_repo.dart';
    ...
    try {
      ...
      if (responseModel.statusCode == 200) {
        ...
        if (dashboardResponseModel.status?.toLowerCase() == AppStatus.SUCCESS.toLowerCase()) {
          String kv = dashboardResponseModel.data?.agent?.kv ?? "";
          String? kycRejectionReason = dashboardResponseModel.data?.agent?.kycRejectionReason;
          ...
          accountBalance = dashboardResponseModel.data?.agent?.balance ?? "0.00";
          SharedPreferenceService.setUserBalance(accountBalance);
          SharedPreferenceService.setString(
            SharedPreferenceService.userImageKey,
            dashboardResponseModel.data?.agent?.getAgentImageUrl() ?? "",
          );
        } else {
          isLoading = false;
          update();

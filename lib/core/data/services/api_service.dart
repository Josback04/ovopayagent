...
import 'package:ovopayagent/core/data/middleware/auth_middleware.dart';
import 'package:ovopayagent/core/data/middleware/kyc_middle_ware.dart';
import 'package:ovopayagent/core/data/middleware/maintenance_middle_ware.dart';
import 'package:ovopayagent/core/data/middleware/middleware_group.dart';
import 'package:ovopayagent/core/data/middleware/no_internet_middleware.dart';
import 'package:ovopayagent/core/data/middleware/profile_status_middleware.dart';
    ...
    _dio.interceptors.add(
      InterceptorsWrapper(
        ...
        onResponse: (response, handler) {
          ...
          printX("""
            *** API Response ***
            ...
            URL DATA: ${response.requestOptions.uri}
        ...
        onError: (DioException error, handler) {
          ...
          printE("""
          *** API Error ***
          Error URL: ${error.requestOptions.uri}

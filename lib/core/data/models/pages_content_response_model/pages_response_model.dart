...
class PagesResponseModel {
  ...
  PagesResponseModel.fromJson(dynamic json) {
    _remark = json['remark'];
    _status = json['status'];
...
class Data {
  Data({List<PagesData>? policyPages}) {
  ...
  Data.fromJson(dynamic json) {
    if (json['policies'] != null) {
      ...
      json['policies'].forEach((v) {
        _policyPages?.add(PagesData.fromJson(v));
      });
    }
  }
  List<PagesData>? _policyPages;

  List<PagesData>? get policyPages => _policyPages;
